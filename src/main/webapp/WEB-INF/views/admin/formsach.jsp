							...
							<div class="card">
								...
								<div class="card-body">
									<div class="form-group">
										<label>Mã Sách</label>
										<form:input path="masach"  type="text" class="form-control" placeholder="Nhập Mã Sách"/>
										<td><form:errors path="masach" cssClass="error" /></td>
									</div>
									<div class="form-group">
										<label>Tên Sách</label>
										<form:input path="tensach"  type="text" class="form-control" placeholder="Nhập Tên Sách"/>
										<td><form:errors path="tensach" cssClass="error" /></td>
									</div>
									<div class="form-group">
										<label for="exampleFormControlSelect1">Loại Sách</label>
										<form:input path="maLoai"  type="text" class="form-control" placeholder="Nhập Loại Sách"/>
										<td><form:errors path="maLoai" cssClass="error" /></td>
									</div>
									<div class="form-group">
										<label>Tác Giả</label>
										<form:input path="tacgia"  type="text" class="form-control" placeholder="Nhập Tên Tác Giả"/>
										<td><form:errors path="tacgia" cssClass="error" /></td>
									</div>
									<div class="form-group">
										<label>Giá</label>
										<form:input path="gia"  type="text" class="form-control" placeholder="Nhập Giá Sách"/>
										<td><form:errors path="gia" cssClass="error" /></td>
									</div>
									<div class="form-group">
										<label>Năm Xuất Bản</label>
										<form:input path="namxuatban"  type="date" class="form-control" placeholder="Nhập Năm Xuất Bản"/>
										<td><form:errors path="namxuatban" cssClass="error" /></td>
									</div>
									<div class="form-group">
										<label>Số Lượng</label>
										<form:input path="soluong"  type="text" class="form-control" placeholder="Số lượng"/>
										<td><form:errors path="soluong" cssClass="error" /></td>
									</div>
									<div class="mb-3">
										
									  <label for="formFileDisabled" class="form-label">Chọn file hình</label>
									  <form:input path="hinh" name="file" type="file" class="form-control" placeholder="" value = "${linkhinh}"/>
										<td><form:errors path="hinh" cssClass="error" /></td>
						...
						<div class="col-md-8">
							<table class="table table-bordered">
								...
								<tr>
									...
									<td>${item.soluong}</td>
									<td><a href="/sachForm/editSach/${item.masach}">Sửa</a></td>
								<tr>
								</c:forEach>
								<table>
